...
var Pax = (() => {
  ...
  function convertModifiers(event2) {
    let modifiers = [];
    if (event2.shiftKey) modifiers.push("Shift");
    if (event2.ctrlKey) modifiers.push("Control");
    if (event2.altKey) modifiers.push("Alt");
    if (event2.metaKey) modifiers.push("Command");
    return modifiers;
  }
