...
fn recurse_pratt_parse_to_string<'a>(
    ...
    pratt_parser
        ...
        .map_infix(|lhs, op, rhs| match op.as_rule() {
            ...
            Rule::xo_rel_eq => {format!("PaxAny::Builtin(PaxValue::Bool({}=={}))", lhs, rhs)},
            Rule::xo_rel_gt => {format!("PaxAny::Builtin(PaxValue::Bool({}>{}))", lhs, rhs)},
            Rule::xo_rel_gte => {format!("PaxAny::Builtin(PaxValue::Bool({}>={}))", lhs, rhs)},
            Rule::xo_rel_lt => {format!("PaxAny::Builtin(PaxValue::Bool({}<{}))", lhs, rhs)},
