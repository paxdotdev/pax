...
#### Implementations
##### `on_pre_render`
<pre><code class="api-signature language-rust ignore">pub fn on_pre_render(&amp;mut self, ctx: &amp;<a href="../../../api/internal/pax-runtime/api.md#nodecontext">NodeContext</a>)</code></pre>
