# forms
<!-- summary: API docs for pax-std::forms. -->
<!-- tags: api, pax-std -->

## Submodules
- [forms::button](forms/button.md)
- [forms::checkbox](forms/checkbox.md)
...
- [forms::textbox](forms/textbox.md)
- [forms::toast](forms/toast.md)
- [forms::tooltip](forms/tooltip.md)
