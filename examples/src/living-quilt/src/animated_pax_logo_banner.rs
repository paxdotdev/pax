...
pub(crate) fn settled_banner_paths() -> [Vec<PathElement>; 6] {
    [
        banner_path([1.0; 5]),
        p_ring_path(Transform::default()),
        p_counter_path(Transform::default()),
        a_path(Transform::default(), 1.0),
        a_counter_path(Transform::default(), 1.0),
        x_path(XTransform::default()),
    ]
}
