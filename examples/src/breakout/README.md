...
The LLM was prompted using a generated wide-context snapshot of Pax docs and
examples at these commits:
- `c1cec6a3fa3b665d30cb9afafac7ac019aca84d9` for `pax-docs`;
- `8b10fc57e9503b3a08a53e687b9ee5d25555e48f` for `pax-engine`.

The retired prompt generator and its `prompt-v1.0.0.txt` snapshot remain
