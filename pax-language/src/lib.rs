...
fn renamed_rules(rule: &Rule) -> String {
    match rule {
        ...
        Rule::class_value => "string, string list, or expression".to_string(),
        Rule::class_string_list => "class string list".to_string(),
        ...
        Rule::transition_binding_value => "timeline name or inline @timeline block".to_string(),
        Rule::transition_inline_timeline_value => "inline transition timeline".to_string(),
        Rule::transition_inline_timeline_body => "inline transition timeline body".to_string(),
        Rule::double_binding => "two-way binding".to_string(),
        Rule::any_template_value => "literal value, literal object, expression, identifier, @gradient".to_string(),
        ...
        Rule::settings_block_element => "settings block element".to_string(),
        Rule::settings_conditional => "settings conditional".to_string(),
        Rule::settings_conditional_body => "settings conditional body".to_string(),
        Rule::settings_if_branch => "settings if branch".to_string(),
        Rule::settings_else_if_branch => "settings else if branch".to_string(),
        Rule::settings_else_branch => "settings else branch".to_string(),
        ...
        Rule::settings_value => "literal value, literal object, {expression}, @gradient".to_string(),
        ...
        Rule::timeline_marker => "timeline marker (e.g. 24, 250ms, 5f, or 50%)".to_string(),
        Rule::timeline_percent => "percent marker (e.g. 50%)".to_string(),
        Rule::timeline_duration => "duration marker (e.g. 250ms, 1s, or 5f)".to_string(),
        Rule::timeline_duration_unit => "duration unit (ms, s, f)".to_string(),
        ...
        Rule::gradient_stop => "gradient stop".to_string(),
        Rule::gradient_stop_marker => "gradient stop marker".to_string(),
        Rule::gradient_stop_value => "gradient stop color".to_string(),
        ...
        Rule::literal_number_with_unit => "number with unit (e.g. 10px, 10%, 10deg, 10rad, 10ms, 1s, 5f )".to_string(),
        ...
        Rule::literal_number_unit => "unit (px, %, rad, deg, ms, s, f)".to_string(),
        ...
        Rule::expression_grouped_unit => "unit suffix for grouped expression".to_string(),
