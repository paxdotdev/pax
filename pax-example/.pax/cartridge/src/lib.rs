...
pub fn instantiate_expression_table<R: 'static + RenderContext>(
    ...
    vtable.insert(
        ...
        Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
            ...
            #[allow(unused_parens)]
            TypesCoproduct::Size(elem_DOT_width)
        }),
    );
    ...
    vtable.insert(
        ...
        Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
            ...
            #[allow(unused_parens)]
            TypesCoproduct::Transform2D(Transform2D::translate((elem_DOT_x), (elem_DOT_y)))
        }),
    );
    ...
    vtable.insert(
        ...
        Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
            ...
            #[allow(unused_parens)]
            TypesCoproduct::Size(elem_DOT_height)
        }),
    );
...
pub fn instantiate_crate_grids_Grids<R: 'static + RenderContext>(
    ...
    args.component_template = Some(Rc::new(RefCell::new(vec![RepeatInstance::instantiate(
        InstantiationArgs {
            ...
            children: Some(Rc::new(RefCell::new(vec![
                pax_std_primitives::rectangle::RectangleInstance::instantiate(InstantiationArgs {
                    ...
                    size: Some(Rc::new(RefCell::new([
                        ...
                        Box::new(PropertyExpression::new(21)),
                    ]))),
                    children: Some(Rc::new(RefCell::new(vec![]))),
                    component_template: None,
                    scroller_args: None,
            ...
            scroller_args: None,
            slot_index: None,
            repeat_source_expression_vec: Some(Box::new(PropertyExpression::new(18))),
            repeat_source_expression_range: None,
            conditional_boolean_expression: None,
            compute_properties_fn: None,
        },
