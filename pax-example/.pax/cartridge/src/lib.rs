...
pub fn instantiate_expression_table<R: 'static + RenderContext>() -> HashMap<usize, Box<dyn Fn(ExpressionContext<R>) -> TypesCoproduct>> {
    ...
    //Font::new("AZNKnucklesTrial","Italic",64)
    vtable.insert(5, Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
        

        #[allow(unused_parens)]
        TypesCoproduct::__pax_stdCOCOtypesCOCOFont(
            Font::new(("AZN Knuckles Trial".try_into().unwrap()),("Italic".try_into().unwrap()),(Numeric::from(64)),)
        )
    }));
    ...
    vtable.insert(7, Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
        ...
        #[allow(unused_parens)]
        TypesCoproduct::__pax_stdCOCOtypesCOCOAlignment(
            Alignment :: Center .try_into().unwrap()
        )
    }));
...
pax_std_primitives::text::TextInstance::instantiate(
 InstantiationArgs {
    properties: PropertiesCoproduct::Text( Text {
            ...
            paragraph_alignment: Box::new( PropertyExpression::new(7) ),
