...
pax_std_primitives::text::TextInstance::instantiate(
 InstantiationArgs {
    properties: PropertiesCoproduct::Text( Text {
            ...
            font: Box::new( PropertyExpression::new(10) ),
        
            fill: Box::new( PropertyExpression::new(8) ),
        
            alignment_multiline: Box::new( PropertyLiteral::new(Default::default()) ),
        
            alignment_vertical: Box::new( PropertyLiteral::new(VAlignment
        :: Center.try_into().unwrap()) ),
        
            alignment_horizontal: Box::new( PropertyLiteral::new(Alignment :: Center.try_into().unwrap()) ),
