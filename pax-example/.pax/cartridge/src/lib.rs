...
pub fn instantiate_expression_table<R: 'static + RenderContext>() -> HashMap<usize, Box<dyn Fn(ExpressionContext<R>) -> TypesCoproduct>> {
    ...
    vtable.insert(2, Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
        ...
        #[allow(unused_parens)]
        TypesCoproduct::__pax_stdCOCOtypesCOCOtextCOCOFont(
            Font::local(("Esenka".try_into().unwrap()),("assets/fonts/Esenka.otf".try_into().unwrap()),(FontStyle :: Normal.try_into().unwrap()),(FontWeight :: Normal.try_into().unwrap()),)
        )
    }));
    ...
    vtable.insert(4, Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
        ...
        #[allow(unused_parens)]
        TypesCoproduct::OptionLABR__pax_stdCOCOtypesCOCOtextCOCOLinkStyleRABR(
            LinkStyle::arbitrary()
        )
    }));
    ...
    vtable.insert(5, Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
        ...
        #[allow(unused_parens)]
        TypesCoproduct::__pax_stdCOCOtypesCOCOtextCOCOSizeWrapper(
            SizeWrapper::set((Numeric::from(32)),)
        )
    }));
    ...
    vtable.insert(6, Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
        ...
        #[allow(unused_parens)]
        TypesCoproduct::__pax_stdCOCOtypesCOCOColor(
            Color::rgba((Numeric::from(1.0)),(Numeric::from(1.0)),(Numeric::from(1.0)),(Numeric::from(1.0)),)
        )
    }));
...
pax_std_primitives::text::TextInstance::instantiate(
 InstantiationArgs {
    properties: PropertiesCoproduct::Text( Text {
            ...
            text: Box::new( PropertyLiteral::new("Welcome to [Pax](https://www.pax.rs)!".try_into().unwrap()) ),
        
            font: Box::new( PropertyExpression::new(2) ),
        
            fill: Box::new( PropertyExpression::new(6) ),
        
            size_font: Box::new( PropertyExpression::new(5) ),
        
            style_link: Box::new( PropertyExpression::new(4) ),
        
            align_multiline: Box::new( PropertyLiteral::new(Some((TextAlignHorizontal :: Right.try_into().unwrap()),)) ),
        
            align_vertical: Box::new( PropertyLiteral::new(TextAlignVertical :: Center.try_into().unwrap()) ),
        
            align_horizontal: Box::new( PropertyLiteral::new(TextAlignHorizontal ::
...
,
    ...
    slot_index: None,
    repeat_source_expression_vec: None,
    repeat_source_expression_range: Some(Box::new(PropertyExpression::new(12))),
    conditional_boolean_expression: None,
    compute_properties_fn: None,
})
,
