...
ret.font = Box::new(PropertyExpression::new(14));
ret.font_size = Box::new(PropertyLiteral::new(Size::Pixels(60.into()).into()));
ret.color = Box::new(PropertyExpression::new(15));
...
pax_std_primitives::frame::FrameInstance::instantiate(
 InstantiationArgs {
    ...
    size: Some(Rc::new(RefCell::new(
        [Box::new(PropertyExpression::new(19)),Box::new(PropertyExpression::new(17))]
    ))),
    children: Some(Rc::new(RefCell::new(vec![
