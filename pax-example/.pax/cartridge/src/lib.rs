...
use pax_runtime_api::{
    ArgsCoproduct, PropertyInstance, PropertyLiteral, Size, Size2D, SizePixels, Transform2D,
};
...
pub fn instantiate_expression_table<R: 'static + RenderContext>(
    ...
    vtable.insert(
        ...
        Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
            #[allow(unused_parens)]
            TypesCoproduct::Range_isize_(0..2)
        }),
    );
    ...
    vtable.insert(
        ...
        Box::new(|ec: ExpressionContext<R>| -> TypesCoproduct {
            ...
            #[allow(unused_parens)]
            TypesCoproduct::__pax_stdCOCOtypesCOCOColor(Color::hlc(
...
pub fn instantiate_component_Grids<R: 'static + RenderContext>(
    ...
    args.handler_registry = Some(Rc::new(RefCell::new(HandlerRegistry {
        click_handlers: vec![],
        will_render_handlers: vec![],
        did_mount_handlers: vec![|properties| {
            ...
            Grids::handle_did_mount(properties);
        }],
        scroll_handlers: vec![],
    })));
    ...
    args.compute_properties_fn = Some(Box::new(|properties, rtc| {
        ...
        {
            let new_value = if let TypesCoproduct::__usize(v) = new_value {
                v
            } else {
                unreachable!()
            };
        ...
        {
            let new_value =
                if let TypesCoproduct::VecLABR__crateCOCOgridsCOCORectDefRABR(v) = new_value {
                    v
                } else {
                    unreachable!()
                };
...
pub fn instantiate_root_component<R: 'static + RenderContext>(
    instance_registry: Rc<RefCell<InstanceRegistry<R>>>,
) -> Rc<RefCell<ComponentInstance<R>>> {
            ...
            pax_std_primitives::frame::FrameInstance::instantiate(InstantiationArgs {
                ...
                children: Some(Rc::new(RefCell::new(vec![
                    ConditionalInstance::instantiate(InstantiationArgs {
                        ...
                        children: Some(Rc::new(RefCell::new(vec![instantiate_component_Grids(
                    ...
                    ConditionalInstance::instantiate(InstantiationArgs {
                        ...
                        children: Some(Rc::new(RefCell::new(vec![
                            instantiate_component_Fireworks(
                                Rc::clone(&instance_registry),
                                InstantiationArgs {
                                    properties: PropertiesCoproduct::Fireworks(Fireworks {
                                        ...
                                        heartbeat: Box::new(PropertyLiteral::new(
                                            Default::default(),
                                        )),
                                    }),
...
pub fn instantiate_component_Fireworks<R: 'static + RenderContext>(
    instance_registry: Rc<RefCell<InstanceRegistry<R>>>,
    mut args: InstantiationArgs<R>,
) -> Rc<RefCell<ComponentInstance<R>>> {
        ...
        pax_std_primitives::group::GroupInstance::instantiate(InstantiationArgs {
            ...
            children: Some(Rc::new(RefCell::new(vec![RepeatInstance::instantiate(
                InstantiationArgs {
                    ...
                    slot_index: None,
                    repeat_source_expression_vec: None,
                    repeat_source_expression_range: Some(Box::new(PropertyExpression::new(4))),
                    conditional_boolean_expression: None,
                    compute_properties_fn: None,
                },
            )]))),
    ...
    args.handler_registry = Some(Rc::new(RefCell::new(HandlerRegistry {
        click_handlers: vec![],
        will_render_handlers: vec![|properties, args| {
            let properties = &mut *properties.as_ref().borrow_mut();
            let properties = if let PropertiesCoproduct::Fireworks(p) = properties {
                p
            } else {
    ...
    args.compute_properties_fn = Some(Box::new(|properties, rtc| {
        ...
        if let Some(new_value) =
            rtc.compute_eased_value(properties.heartbeat._get_transition_manager())
        {
            properties.heartbeat.set(new_value);
        } else if let Some(new_value) =
            rtc.compute_vtable_value(properties.heartbeat._get_vtable_id())
        {
            let new_value = if let TypesCoproduct::__f64(v) = new_value {
                v
            } else {
