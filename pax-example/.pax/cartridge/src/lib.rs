...
pub fn instantiate_src_camera_rs_Camera<R: 'static + RenderContext>(
            ...
            pax_std_primitives::frame::FrameInstance::instantiate(InstantiationArgs {
                ...
                children: Some(Rc::new(RefCell::new(vec![
                    ConditionalInstance::instantiate(InstantiationArgs {
                        ...
                        children: Some(Rc::new(RefCell::new(vec![
                            instantiate_src_fireworks_rs_Fireworks(
                    ...
                    ConditionalInstance::instantiate(InstantiationArgs {
                        ...
                        children: Some(Rc::new(RefCell::new(vec![
                            instantiate_src_hello_rgb_rs_HelloRGB(
                                Rc::clone(&instance_registry),
                                InstantiationArgs {
                    ...
                    ConditionalInstance::instantiate(InstantiationArgs {
                        ...
                        children: Some(Rc::new(RefCell::new(vec![
                            instantiate_src_camera_rs_Camera(
                                Rc::clone(&instance_registry),
                                InstantiationArgs {
...
pub fn instantiate_src_fireworks_rs_Fireworks<R: 'static + RenderContext>(
    instance_registry: Rc<RefCell<InstanceRegistry<R>>>,
    mut args: InstantiationArgs<R>,
) -> Rc<RefCell<ComponentInstance<R>>> {
    args.component_template = Some(Rc::new(RefCell::new(vec![
...
pub fn instantiate_src_hello_rgb_rs_HelloRGB<R: 'static + RenderContext>(
    instance_registry: Rc<RefCell<InstanceRegistry<R>>>,
    mut args: InstantiationArgs<R>,
) -> Rc<RefCell<ComponentInstance<R>>> {
    args.component_template = Some(Rc::new(RefCell::new(vec![
