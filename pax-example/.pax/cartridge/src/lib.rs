...
,
    ...
    slot_index: None,
    repeat_source_expression_vec: None,
    repeat_source_expression_range: Some(Box::new(PropertyExpression::new(11))),
    conditional_boolean_expression: None,
    compute_properties_fn: None,
})
,
...
,
    ...
    repeat_source_expression_vec: None,
    repeat_source_expression_range: None,
    conditional_boolean_expression: Some(Box::new(PropertyExpression::new(18))),
    compute_properties_fn: None,
})
,
...
pax_std_primitives::frame::FrameInstance::instantiate(
 ...
 handler_registry}
    ...
    size: Some(Rc::new(RefCell::new(
        [Box::new(PropertyExpression::new(26)),Box::new(PropertyExpression::new(24))]
    ))),
    children: Some(Rc::new(RefCell::new(vec![
...
SlotInstance::instantiate(
 ...
 handler_registry}
    ...
    component_template: None,
    scroller_args: None,
    slot_index: Some(Box::new(PropertyExpression::new(27))),
    repeat_source_expression_vec: None,
    repeat_source_expression_range: None,
    conditional_boolean_expression: None,
    compute_properties_fn: None,
...
,
    ...
    scroller_args: None,
    slot_index: None,
    repeat_source_expression_vec: Some(Box::new(PropertyExpression::new(23))),
    repeat_source_expression_range: None,
    conditional_boolean_expression: None,
    compute_properties_fn: None,
})
...
ret.font = Box::new(PropertyExpression::new(28));
ret.font_size = Box::new(PropertyLiteral::new(Size::Pixels(60.into()).into()));
ret.fill = Box::new(PropertyExpression::new(29));
...
pax_std_primitives::image::ImageInstance::instantiate(
 ...
 handler_registry}
    ...
    instance_registry: Rc::clone(&instance_registry),
    transform: Rc::new(RefCell::new(PropertyExpression::new(30))),
    size: Some(Rc::new(RefCell::new(
