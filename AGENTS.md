...
- Squash commits follow a convention of "summary commit message\n\n0e124312 commit 01's message\n33efa232 commit 02's message\n aefe2222 commit 03's message...".  for example:

```
    stacker animations

    7e51095bc wip: stacker transitions
    4466a83e1 docs
    086493641 cleaning
    e8d9546b7 tune animations and defaults
